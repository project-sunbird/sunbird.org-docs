...
|ml_cloud_config|ml-core|Update in `Core/common.yml`<pre> `ml_cloud_config: \|` <br>  `CLOUD_STORAGE=AZURE` <br>`  AZURE_ACCOUNT_NAME="{{sunbird_public_storage_account_name}}"` <br>`  AZURE_ACCOUNT_KEY="{{sunbird_public_storage_account_key}}"` <br>`  AZURE_ACCOUNT_SAS="{{sunbird_public_storage_account_sas}}"` <br>`  AZURE_STORAGE_CONTAINER=samiksha` </pre>|
...
|||Provision/DataPipeline/Druid|release-4.3.0_RC2||
...
|Build/Core/Groups|release-4.3.0_RC2|Deploy/Kubernetes/Groups|release-4.3.0_RC3||
...
|Build/Core/Notification|release-4.3.0_RC3|Deploy/Kubernetes/Notification|release-4.3.0_RC3||
