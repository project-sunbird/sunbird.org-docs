...
| Add new variables in Core/common.yml | PA |  | `kong_desktop_device_consumer_names_for_opa: '["desktop_devicev2", "desktop_device"]'` | To disable checks for desktop app |
...
|:-----------:|:-----------:|:---------:|
|Install OPA | curl -k -L -o opa <br>https://openpolicyagent.org/downloads/v0.34.2/opa_linux_amd64_static<br>chmod 755 ./opa<br>sudo mv opa /usr/local/bin/ | Installing Open Policy Agent |
