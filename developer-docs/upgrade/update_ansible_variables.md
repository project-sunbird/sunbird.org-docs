...
published: true
allowSearch: true
keywords: Upgrade, Sunbird 3.1.0, variable, Ansible updates
---
## Overview
...
3.git checkout tags/release-3.1.0 -b release-3.1.0  
...
This will show the differences in variables between release-2.5.0 and release-3.1.0. If the line is in green, it means its newly added. If the line is in red, it means it has been removed.
