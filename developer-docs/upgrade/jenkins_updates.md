...
published: true
allowSearch: true
keywords: Upgrade, Sunbird 3.6.0, jenkins updates
---
## Overview
...
7.Go to Manage Jenkins → Configure System → Update `public_repo_branch` to `refs/tags/release-3.6.0_RC8` or go to Manage Jenkins → Configure System → Update `private_repo_branch` to the branch name of your private repo branch in case you created a new branch for release-3.6.0 inventory updates  
