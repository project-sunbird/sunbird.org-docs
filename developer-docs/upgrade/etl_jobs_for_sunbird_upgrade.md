...
>For details, refer to the [Sync User and Organization](developer-docs/installation/sync_user_org.md){:target="_blank"} document to understand and run the appropriate script. 
