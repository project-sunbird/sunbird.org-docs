...
|  32 | sunbird_cassandra_urls | Represents the ips address of the Cassandra DB to connnect the Sunbird Content service along with port | Used to connect to cassandra db  | 127.0.0.1:9042 |
...
|  34 | sunbird_cassandra_replication_strategy | Represents data replication of cassandra | Used to replicate the cassandra data set | '{"class":"SimpleStrategy","replication_factor":1}' |
