...
|  29 | device_register_api | Device registry Api | This api is used to register/apture IP address/geolocation/device information |  | https://api.open-sunbird.org/v3/device/register/ |
