...
|----------------|----------------|-------------------------------|-------------------------|--------------|
| Content ID     | String         | Content ID of the Request URL. The content ID is generated by making a create content request using the [Create Content API](http://docs.sunbird.org/latest/apis/content/#operation/Create%20Content) | do_21258058227713638416 | Yes          |

> Note: The path has the following format <base_url>/content/v1/upload/<content_id>. For example, the path using the sample value of the content ID parameter for the sunbird staging environment will be: https://staging.open-sunbird.org/api/content/v1/upload/do_21258058227713638416 
