...
2. Create the organization and users associated with the badge awarding process. Ensure that you have created the specific badge recipient and the user who awards the badge. For details, refer to [How to create organisations](how-to-guide/how_to_create_organization) and [How to create users](../how_to_create_user).
