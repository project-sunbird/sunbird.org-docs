...
Please refer to the [Server Installation Steps](developer-docs/server-installation/){:target="_blank"} if you want to host sunbird on your servers. Sunbird supports various deployment topologies and it can scale for thousands of users. 

## Mobile App Installation

To create a customized Sunbird mobile application for your hosted Sunbird, refer to [Mobile App Setup](developer-docs/mobile-app-installation/){:target="_blank"}
