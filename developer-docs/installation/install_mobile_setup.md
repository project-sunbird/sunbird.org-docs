...
Use the value of "key" and "secret" from the response above for MOBILE_APP_KEY and MOBILE_APP_SECRET configuration in respective environments in gradle.properties file. Example: >>>>>>> 558454d80b192104cdc6610c49594e56f054778d
...
This is a cordova plugin for Android. It exposes some APIs that internally calls to the genie services.

Install this plugin in Sunbird-mobile with the following command:
...
Update <b>drawable-ldpi-icon.png</b> to your required  <b>icon.png file </b> in resource folder and run `ionic cordova run android`, it generates the resource files for this platform and splash image and splash screen automatically get changed it will be added in the <b>config.xml file</b>.

Install this plugin in Sunbird-mobile using the following command:
...
## Consolidated flow
  ...
  2. Then perform all the above-mentioned steps for each cloned repository.

  3. Open the terminal and change the directory to "sunbird-mobile" 
