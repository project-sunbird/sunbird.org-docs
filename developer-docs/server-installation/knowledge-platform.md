...
Switch to the `Build` folder and run all jobs. For the value of the **github_release_tag**, refer to [Current Release Tags and Jenkins Jobs Reference](sunbird.org-docs/developer-docs/server-installation/current_release_tags_n_jenkins_jobs.md){:target="_blank"}
