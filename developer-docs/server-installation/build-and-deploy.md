...
|Deploy/Kubernetes/Monitoring|branch_or_tag: release-4.5.0_RC6, tag: all|<https://github.com/project-sunbird/sunbird-devops.git>|Deploys the monitoring stack which can be accessed via DOMAIN/grafana/ post nginx-public-ingress deployment|
...
|Deploy/Kubernetes/Cassandra|release-4.5.0_RC6|<https://github.com/project-sunbird/sunbird-devops.git>|Creates / Updates Cassandra DB schema|
...
|Deploy/KnowledgePlatform/FlinkJobs|branch_or_tag: release-4.5.0_RC12, job_names_to_deploy: Select All|<https://github.com/project-sunbird/sunbird-learning-platform.git>|Deploys the Flink jobs in Kubernetes cluster|
...
|Deploy/Kubernetes/APIManager|release-4.5.0_RC6|<https://github.com/project-sunbird/sunbird-devops.git>|Deploys Kong, the API gateway |
|Deploy/Kubernetes/OnboardAPIs|release-4.5.0_RC6|<https://github.com/project-sunbird/sunbird-devops.git>|Creates the APIs in Kong|
|Deploy/Kubernetes/OnboardConsumers|release-4.5.0_RC6|<https://github.com/project-sunbird/sunbird-devops.git>|Creates the consumers in Kong. Now read the comment mentioned in **Core/Secrets.yml** against the variable `core_vault_sunbird_api_auth_token`|
|Deploy/Kubernetes/Keycloak|release-4.5.0_RC6|<https://github.com/project-sunbird/sunbird-devops.git>|Deploys Keycloak|
