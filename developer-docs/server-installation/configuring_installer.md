...
|sunbird_image_storage_url|	The Azure storage endpoint url that was created as a pre-requisite. Eg https://sunbirdtravisbuild.blob.core.windows.net/dial/ where dial is the container within the storage account.|Yes
...
|sunbird_custodian_tenant_channel|	The channel value of first tenant organisation. This can be same as the implementation name above.	|Yes
