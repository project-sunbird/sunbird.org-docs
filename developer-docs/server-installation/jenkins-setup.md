...
|**public_repo_branch**|This is the branch or tag to pick the Jenkins file. You can set this value as refs/tags/release-3.7.0_RC15 if you want to build from tags or provide the value of the development branch, for example, release-3.7.0. Changing this value is not recommended since development branches are not stable. |
