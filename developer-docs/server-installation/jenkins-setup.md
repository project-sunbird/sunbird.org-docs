...
- SSH to the Jenkins server and enter the following commands -
     ...
     cd sunbird-devops && git checkout tags/release-4.0.0 -b release-4.0.0
     cd deploy/jenkins
...
- Configure Jenkins
  ```
  sudo su jenkins
  curl -SsL -o ~/jenkins.yaml https://raw.githubusercontent.com/project-sunbird/sunbird-devops/release-4.0.0/deploy/jenkins/jenkins.yaml
